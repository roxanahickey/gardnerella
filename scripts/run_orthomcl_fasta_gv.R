...
dir.out <- "output/orthomcl-fasta-gv"

dna.fasta <- readDNAStringSet("data/cds_dna_short_id_gv_all35.fasta", format="fasta")

aa.fasta <- readAAStringSet("data/cds_aa_short_id_gv_all35.fasta", format="fasta")
