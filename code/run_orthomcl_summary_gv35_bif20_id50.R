...
dir.out <- "results/orthomcl50-gv35-bif20"
dir.fig <- "results/figures/orthomcl50-gv35-bif20"
...
ortho.clust.in <- readLines("data/reference/orthomcl50_gv35_bif20_groups.txt")
ortho.sing.in <- readLines("data/reference/orthomcl50_gv35_bif20_single.txt")
clust.mx.in <- read.table("data/reference/orthomcl50_gv35_bif20_groups_binary.txt", header=T)
