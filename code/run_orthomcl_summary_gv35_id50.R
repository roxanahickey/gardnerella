## Run orthomcl_summary.R for Gardnerella-only OrthoMCL (50% clustering)
## Roxana Hickey <roxana.hickey@gmail.com>
## Last update: 2015-04-23

## set up custom inputs and outputs
dir.out <- "results/orthomcl50-gv35"
dir.fig <- "results/figures/orthomcl50-gv35"
...
ortho.clust.in <- readLines("data/reference/orthomcl50_gv35_groups.txt")
ortho.sing.in <- readLines("data/reference/orthomcl50_gv35_single.txt")
clust.mx.in <- read.table("data/reference/orthomcl50_gv35_groups_binary.txt", header=T)
